...
$alert_message:="error "+String:C10(ERROR)
$alert_message:=" ** ERR ** --> "+Error method+" line #"+String:C10(Error line)+"- "+$alert_message+". Check On Err log for more detail"
APPEND TO ARRAY:C911(gErrorTextArr; $alert_message)

var $maxMemory; $usedMemory : Real
$maxMemory:=Cache info:C1402.maxMem
$usedMemory:=Cache info:C1402.usedMem
APPEND TO ARRAY:C911(gErrorTextArr; "Max Memory:"+String:C10($maxMemory; "###,###,###,###,###0")+"bytes;"\
+" Used Memory:"+String:C10($usedMemory; "###,###,###,###,###0")+"bytes;"\
+" UNUSED Memory:"+String:C10($maxMemory-$usedMemory; "###,###,###,###,###0"))
